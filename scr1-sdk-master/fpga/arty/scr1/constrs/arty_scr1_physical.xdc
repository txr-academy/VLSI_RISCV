...
set_property PULLTYPE PULLDOWN [get_ports {JD[3]}]
set_property PULLTYPE PULLUP [get_ports {JD[2]}]
set_property PULLTYPE PULLUP [get_ports {JD[4]}]
set_property PULLTYPE PULLUP [get_ports {JD[5]}]
set_property PULLTYPE PULLUP [get_ports {JD[6]}]
set_property PULLTYPE PULLUP [get_ports {JD[7]}]
